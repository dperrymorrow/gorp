...
module.exports = async function() {
  ...
  let prompts = [
    ...
    {
      name: "Branch fetch upstream (Master)",
      cmd: "branch:fetch-upstream",
      value: branches.fetchUpstream,
    },
    {
      name: "Branch Compare",
  ...
  prompts = prompts.concat([
...

    {
      cmd: "stage",
      value: files.stage,
      name: defaults.addCount("Stage / unstage files", dirtyCount, "red"),
      disabled: defaults.disabled(!isDirty && !stagedCount, "No changes"),
    },
